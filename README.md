...
- :mortar_board: Recently earned my Master of Science degree, where I specialized in inverse dynamics — an approach to robot control leveraging deep time series analysis. As part of my studies, I was part of the [Micro-Flight Lab](https://www.beatus-lab.org/) research group, where we built a flapping-wing system inspired by biological flight mechanisms.
